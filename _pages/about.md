...
<ul class="news-list">
  ...
  <li><strong>[12/2025]</strong> Presented MSD-Net at ISICDM 2025.</li>
  <li><strong>[11/2025]</strong> Received Outstanding Postgraduate Student, UESTC.</li>
  <li><strong>[10/2025]</strong> First Prize, National Research English Speech Contest; First Prize, UESTC Division.</li>
...
<div class="exp-item">
  ...
  <ul>
    <li>End-to-end AI solution development for CSD-AI, Lenovo&rsquo;s global channel sales data quality platform serving NA/LA/AP/EMEA regions</li>
    <li>Built LLM-based intent recognition models for automated text and email anomaly detection</li>
    <li>Delivered full development-to-production lifecycle from prototyping through deployment and release</li>
  </ul>
</div>
...
<div class="exp-item">
  ...
  <ul>
    <li>Coordinated 3.0T MRI and 64-channel EEG synchronous acquisition for task-driven multimodal datasets</li>
    <li>Performed motion correction, denoising, and functional connectivity preprocessing</li>
  </ul>
</div>
...
<div class="exp-item">
  ...
  <ul>
    <li>Assisted with CAD drafting and document protocol preparation for IoT and digital twin business</li>
  </ul>
</div>
...
<div class="exp-item">
  ...
  <ul>
    <li>Funded by NSFC (Grant No. 82372085, 62333003). Under review at <em>IEEE TNNLS</em>.</li>
  </ul>
</div>
...
<div class="exp-item">
  ...
  <ul>
    <li>Funded by NSFC. Manuscript in preparation.</li>
  </ul>
</div>
...
<div class="exp-item">
  ...
  <ul>
    <li>Step-level PPO reinforcement learning with Progress Reward Model for autonomous phone interaction.</li>
  </ul>
</div>

<div class="exp-item">
  <strong>Agentic RAG</strong> &mdash; <em>Intelligent epilepsy consultation and retrieval system</em>
  <span class="exp-badge project">Independent</span>
  <span class="exp-date">Mar &ndash; May 2026</span>
  <ul>
    <li>BGE-M3 hybrid retrieval + Multi-Query rewriting + LangGraph StateGraph orchestration.</li>
  </ul>
</div>
...
<div class="exp-item">
  ...
  <ul>
    <li>WeChat mini-program with ResNet50-based skin disease classification. National Third Prize.</li>
  </ul>
</div>
...
<div class="exp-item">
  ...
  <ul>
    <li>YOLOv5/PaddleDetection-based system with CTWing platform integration. National Third Prize.</li>
  </ul>
</div>
...
2. <em>Platform for Evaluating the Efficacy of Epilepsy Surgery Based on a Digital Brain Model</em>, Version 1.0, 2025SR0523331, Chinese Software Copyright (filed), 2025.

3. <em>Epilepsy Brain Imaging Consortium Multicenter Data Sharing Platform (EBIC)</em>, Version 1.0, 2026SR0397180, Chinese Software Copyright (filed), 2026.
