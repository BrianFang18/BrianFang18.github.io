...
- **M.Eng. in Biomedical Engineering**, UESTC, 2024 – 2027 (Expected)
  - GPA: 3.43/4.0 | Top 5% in cohort | Tianfu AI Honors Program
  - Supervisor: Prof. Rong Li, Prof. Huafu Chen

- **B.Eng. in Communications Engineering**, CUIT, 2020 – 2024
  - GPA: 3.51/4.0 | Top 1% in cohort | Outstanding Graduate of Sichuan Province

### Work & Internship

- **Lenovo**, Solutions & Services Group — *AI Application Development Engineer Intern*, Jun 2026 – Sep 2026
  - End-to-end AI solution development for CSD-AI, Lenovo's global channel sales data quality platform serving NA/LA/AP/EMEA regions
...
|-------|-------------|------|
| First-Class Academic Scholarship (Top 10%) | UESTC | 2024, 2025 |
...
1. *A Method for Identifying Epileptic Abnormal Brain Networks Based on a Multiscale Static-Dynamic Fusion Network*, CN 2025115041286, China Patent (filed), 2025.

2. *Platform for Evaluating the Efficacy of Epilepsy Surgery Based on a Digital Brain Model*, Version 1.0, 2025SR0523331, Chinese Software Copyright (filed), 2025.

3. *Epilepsy Brain Imaging Consortium Multicenter Data Sharing Platform (EBIC)*, Version 1.0, 2026SR0397180, Chinese Software Copyright (filed), 2026.
